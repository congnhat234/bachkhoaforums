...
<div class="container">
	...
	<ul class="menu">
		...
		<li class="dropdown"><a href="#" id="dropbutton3" class="dropbtn">Cài
				đặt</a>
			<div class="dropdown_content">
				<a href="#">Thông tin cá nhân</a> <a href="#">Mật khẩu</a> <a
					href="#">Đăng xuất</a>
			</div></li>
	</ul>
	<!-- Tab links -->
	<div class="tab">
		<button class="tablinks" onclick="openActive(event, 'InfomationUser')"
			id="defaultOpen">Thông tin</button>
		<button class="tablinks" onclick="openActive(event, 'ChangePassword')"
			id="defaultOpen1">Đổi mật khẩu</button>
	</div>
	<!-- Tab content -->
				...
				<fieldset>
					<dl class="ctrlUnit avatarEditor">
						...
						<dd>
							...
							</a> <br> <input id="imginput" type="file" name="avatar"
								value="" id="" class="textCtrl OptOut">
						</dd>
					</dl>
				</fieldset>
				<fieldset>
		...
		<div class="module">
			...
			<div class="module-body">
				<form id="addCat" method="POST"
					...
					<fieldset>
						<input class="button" type="submit" value="Thêm" /> <input
