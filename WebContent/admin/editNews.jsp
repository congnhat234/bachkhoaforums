...
<div class="grid_12">
	...
	<div class="module">
		 ...
		 <div class="module-body">
			...
			%>
			<form id="editNews" method="POST" action="<%=request.getContextPath() %>/admin/editNews?nid=<%=objNews.getId_news()%>" enctype="multipart/form-data">
				<p>
					<label>Tên tin</label>
					<input id="tentin" type="text" name="tentin" value="<%=objNews.getName() %>" class="input-medium" />
				</p>
				<p>
				...
				<p>
					<label>Mô tả</label>
					<textarea id="mota" name="mota" value="" rows="7" cols="90" class="input-medium"><%=objNews.getPreview_text() %></textarea>
				</p>
				<p>
					<label>Chi tiết</label>
					<textarea  name="chitiet" value="" rows="7" cols="90" class="ckeditor"><%=objNews.getDetail_text() %></textarea>
				</p>
				<fieldset>
