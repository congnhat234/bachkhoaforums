...
public class Post {
	...
	public Post(int id_post, int id_subject, int id_user, String username, String date_create, String title,
			String preview_image, String preview_content, String content, int view, int enable) {
		super();
